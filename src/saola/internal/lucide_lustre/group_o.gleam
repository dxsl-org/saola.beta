...
pub fn octagon(attributes: List(Attribute(a))) {
  svg.svg(
    [
...
pub fn option(attributes: List(Attribute(a))) {
  svg.svg(
    ...
    [
      svg.path([a("d", "M3 3h6l6 18h6")]),
      svg.path([a("d", "M14 3h7")]),
    ],
  )
}
...
pub fn orbit(attributes: List(Attribute(a))) {
  svg.svg(
    ...
    [
      svg.path([a("d", "M20.341 6.484A10 10 0 0 1 10.266 21.85")]),
      svg.path([a("d", "M3.659 17.516A10 10 0 0 1 13.74 2.152")]),
      svg.circle([
        a("r", "3"),
        a("cy", "12"),
        a("cx", "12"),
...
pub fn origami(attributes: List(Attribute(a))) {
  svg.svg(
    ...
    [
      svg.path([
        a("d", "M12 12V4a1 1 0 0 1 1-1h6.297a1 1 0 0 1 .651 1.759l-4.696 4.025"),
      ]),
      svg.path([
        a(
          "d",
